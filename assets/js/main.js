...
$('#nextBtn').on('click', function() {
  ...
  $(".count-decreament").click(function (e) {
   ...
   // Same Shipping Address Toggle (This is moved to checkout.html's inline script for direct DOM manipulation)
...
// Removed the cart-related JavaScript from here. It's now in cart-management.js.
// Add this inside your $(function() { ... }); block or after the addToCart function definition

document.querySelectorAll('.add-to-cart-btn').forEach(button => {
    button.addEventListener('click', () => {
        // You'll need to get the product details dynamically here
        // This is a placeholder; adjust based on your HTML structure
        const product = {
            id: button.dataset.productId, // Assuming a data-product-id attribute
            name: button.dataset.productName,
            unitPrice: parseFloat(button.dataset.productPrice),
            image: button.dataset.productImage,
            model: button.dataset.productModel // Assuming a data-product-model attribute
        };
        addToCart(product);
    });
});
